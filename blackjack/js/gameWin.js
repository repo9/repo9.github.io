...
function updateChipBalance() {
	if (gameWinner === "player") {
		...
		if (splitGame === false && playerHasAce === true && playerHandTotal === 21 && player_Hand.length === 2) {
			currentChipBalance += current_wager*(3/2) + current_wager;
		// Otherwise it's a 1:1 payout:
		} else {
			currentChipBalance += current_wager*2;
		}
