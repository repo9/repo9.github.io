...
function cusAlert(m, id)
{
    ...
    aDivAlrt.style.width = 400+"px";
    aDivAlrt.style.background = "#000";
    aDivAlrt.style.padding = 0+"px";
    aDivAlrt.style.top = 0+"px";
    //aDivAlrt.style.left = 0+"px";
    //aDivAlrt.style.boxShadow = "0px 0px 10px 0px #000";
    ...
    //document.getElementsByTagName("body")[1].appendChild(aDivAlrt);

    document.getElementById(id).appendChild(aDivAlrt);
